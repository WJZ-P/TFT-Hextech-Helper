...
/**
 * 不可购买的棋子名称集合
 * @description 这些棋子无法在商店中购买，它们是由海克斯科技、技能召唤、羁绊效果等系统机制生成的单位。
 *              前端在展示棋子池（如自定义阵容的拖拽选择器）时，应过滤掉这些棋子。
 *
 *              按来源分类：
 *              - 【锻造器类】基础/成装/神器/辅助装锻造器：海克斯科技奖励的装备选择器，不是真正的棋子
 *              - 【系统赠送】训练假人：系统赠送的假人单位
 *              - 【海克斯召唤】魔像："魔像化"海克斯生成的单位
 *              - 【技能召唤】提伯斯：安妮技能召唤的熊
 *              - 【羁绊召唤 S17】迷你黑洞：暗星羁绊场上生成的召唤物
 *              - 【羁绊产物 S17】未来战士核心：未来战士攒经验生成的道具单位，备战席显示为"时空核心"
 */
export const UNPURCHASABLE_CHESS: ReadonlySet<string> = new Set([
    ...
    "提伯斯",
    "迷你黑洞",         // S17 暗星羁绊召唤物
    "未来战士核心",     // S17 未来战士羁绊产物（备战席显示为"时空核心"）
]);
