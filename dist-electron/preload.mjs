...
const configApi = {
  backup: electron.ipcRenderer.invoke("config-backup"),
  restore: electron.ipcRenderer.invoke("config-restore")
};
electron.contextBridge.exposeInMainWorld("config", configApi);
const lcuApi = {
  getSummonerInfo: () => {
    return electron.ipcRenderer.invoke("lcu-request123", "GET", "/lol-summoner/v1/current-summoner");
  },
